...
//checa se os botões clicados foram os mesmos da ordem gerada no jogo
let ckeckOrder = () => {
...
let playGame = () => {
    alert('Benvindo ao Gênesis! Iniciando novo jogo!');
    score = 0;
